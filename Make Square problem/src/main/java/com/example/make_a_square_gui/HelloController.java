...
public class HelloController implements Initializable {
    ...
    void paintButton()
    {
        ...
        arrColor.add("-fx-background-color: blue;");
        arrColor.add("-fx-background-color: pink;");
        arrColor.add("-fx-background-color: cyan;");
        arrColor.add("-fx-background-color: orange;");
        arrColor.add("-fx-background-color: black;");
        for(int i=0;i<4;i++)
        {
            for(int j=0;j<4;j++)
            {
